...
\begin{spacing}{0.7}
\phantomsection\addcontentsline{toc}{section}{Index des questions avec des éléments d'évaluation}
\hypertarget{indexc}{}
\indexprologue{\textit{Les questions sont classées par type (essai ou interprétation, littéraire ou philosophique) puis par ordre alphabétique de la première lettre de la question. Les « caractères spéciaux (guillemets, lettres accentuées) se trouvent indexées à la fin. »  Pour les essais, on a juste mentionné le lieu de l'épreuve ainsi que la session du baccalauréat. Pour les questions d'interprétation, il a semblé pertinent d'ajouter le texte sur lequel porte la question.}}
\printindex[c]
\end{spacing}
...
\begin{spacing}{0.9}
\phantomsection\addcontentsline{toc}{section}{Index des références culturelles, œuvres et auteurs cités dans les éléments d'évaluation}
\hypertarget{indexr}{}
\indexprologue{\textit{On ne fait pas figurer dans cet index l'auteur du texte sur lequel porte explicitement le sujet, puisque, par définition, l'auteur est mobilisé pour répondre à la question. On a essayé d'indexer toute référence clairement identifiable à une œuvre ou un auteur unique (ainsi, on n'a pas indexé « Les Romantiques » pourtant mentionnés à plusieurs reprises). Certaines entrées ne font pas référence à un auteur mais un domaine, un collectif ou un ensemble qu'il paraissait plus pertinent d'indexer sous un terme plus générique~: Associations, Bible, Chanson, Cinéma, Collectifs d'écrivains, Commission juridique, Figures historiques, Journaux, Mythes, Sophistes, Textes juridiques.}}
\printindex[r]
\end{spacing}
...
\item \textbf{Sur le rapport à la culture~:} ambition, culture, lecture, loisirs, socialisation.
...
\item \textbf{Sur le rapport à soi~:} biographie, changement, conscience, corps, intime, introspection \textit{et sa sous-entrée} « se trouver », langage, mensonge, mémoire, moi \textit{et ses sous-entrées}, narcissisme, nostlagie, personnage, personnalité, sincérité, soi \textit{et ses sous-entrées}, solitude, sujet, tristesse.
...
\item \textbf{Sur les âges ou étapes de la vie~:} adulte, adolescence,  enfant, enfance, existence, famille, maladie, naissance, parent, regrets, souvenir, temps \textit{et sa sous-entrée} passage du temps, vie (âge de la vie), vieillesse.
...
\item \textbf{Sur l'écologie~:} autolimitation, destruction, écologie, nature (environnement), principe de précaution, technique (maîtrise technique de la nature).
